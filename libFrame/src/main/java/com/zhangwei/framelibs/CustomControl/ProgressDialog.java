...
public class ProgressDialog extends Dialog {
    ...
    public ProgressDialog(Context context, String text, boolean showProcess) {
        this(context, text, true, showProcess);
    }

    public ProgressDialog(Context context, int text, boolean showProcess) {
        this(context, text, true, showProcess);
    }

    public ProgressDialog(Context context, String text, boolean showProcess, boolean canCanel) {
    ...
    public ProgressDialog(Context context, int text, boolean showProcess, boolean canCanel) {
        super(context, R.style.customDialog);
        this.txt = context.getString(text);
        this.canCanel = canCanel;
        this.showProcess = showProcess;
    }
